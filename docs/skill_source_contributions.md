...
| 3 | https://officialskills.sh/openai/skills | n/a | OfficialSkills lists 42 OpenAI-published skills including `openai-docs`, `gh-fix-ci`, `playwright`, `chatgpt-apps`, and security review skills. | High-confidence source for Codex/OpenAI workflow skills and platform-specific named capabilities. |
